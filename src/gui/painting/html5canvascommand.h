...
{
public:
    enum CommandType { GetMainCanvasWidth, GetMainCanvasHeight, ClearCanvas, GetCanvasPixels, GetHandleForMainCanvas, CreateCanvas, FillSolidRect, StrokeRect, FillRect, StrokeEllipse, FillEllipse, ChangePenColor, ChangePenThickness, ChangeBrushColor, ChangeBrushTexture, SavePaintState, RestorePaintState, RestoreToOriginalState, SetClipRect, SetTransform, SetCanvasPixelsRaw, DrawCanvasOnMainCanvas, DrawCanvasOnCanvas, DrawStretchedCanvasPortionOnCanvas, ProcessEvents};
