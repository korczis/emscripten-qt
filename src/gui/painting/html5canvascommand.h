...
{
public:
    enum CommandType { GetMainCanvasWidth, GetMainCanvasHeight, ClearCanvas, GetCanvasPixels, GetHandleForMainCanvas, CreateCanvas, FillSolidRect, StrokeRect, FillRect, StrokeEllipse, FillEllipse, DrawLine, ChangePenColor, ChangePenThickness, ChangeBrushColor, ChangeBrushTexture, CreateLinearGradient, AddStopPointToCurrentGradient, SetBrushToCurrentGradient, SavePaintState, RestorePaintState, RestoreToOriginalState, SetClipRect, BeginPath, AddRectToCurrentPath, SetClipToCurrentPath, SetTransform, SetCanvasPixelsRaw, DrawCanvasOnMainCanvas, DrawCanvasOnCanvas, DrawStretchedCanvasPortionOnCanvas, ProcessEvents};
